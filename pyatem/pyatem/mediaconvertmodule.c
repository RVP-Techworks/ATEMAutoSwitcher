...
const double bt709_coeff_r = BT709_COEFF_R;
const double bt709_coeff_g = BT709_COEFF_G;
const double bt709_coeff_b = BT709_COEFF_B;
double bt709_coeff_ri;
double bt709_coeff_bi;
double bt709_coeff_bg;
double bt709_coeff_rg;

double bt709_ri_range;
double bt709_bi_range;

void initialize_constants() {
    bt709_coeff_ri = 1.0 - bt709_coeff_r;
    bt709_coeff_bi = 1.0 - bt709_coeff_b;
    bt709_coeff_bg = bt709_coeff_b / bt709_coeff_g;
    bt709_coeff_rg = bt709_coeff_r / bt709_coeff_g;

    bt709_ri_range = bt709_coeff_ri / CR_MIDDLE;
    bt709_bi_range = bt709_coeff_bi / CR_MIDDLE;
}
